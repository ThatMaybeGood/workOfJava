...
public class RestTemplateConfig {
    ...
    // 声明并注入我们自定义配置的 ObjectMapper  自动包含 JacksonConfig 中设置的 SNAKE_CASE 命名策略
    private final ObjectMapper objectMapper;

    // 通过构造器注入 JacksonConfig 中定义的 ObjectMapper Bean
    @Autowired
    ...
    public RestTemplate restTemplate() {
        ...
        // 添加 JSON 转换器 (使用ObjectMapper，解决了命名策略和流读取问题)
