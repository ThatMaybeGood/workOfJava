 ...
 */
public enum ApiType {
    HIS_DATA("hisData", HisData.class),
    // 增加枚举值，例如 HIS_REPORT
    HIS_REPORT("hisReport", HisOperator.class),
    // 增加枚举值，例如 HOLIDAY_CALENDAR
    HOLIDAY_CALENDAR("holidayCalendar",HolidayCalendar .class),

    // 增加新的枚举值，例如 HIS_OPERATOR
    HIS_OPERATOR("hisOperator", HisOperator.class),
