...
const menuConfig = [
    {
        ...
        items: [
            ...
            { label: '门诊服务质量分析', file: 'outpatient/outpatient-service-quality.html', icon: 'bi-award' },
            { label: '门诊管理质量控制', file: 'outpatient/outpatient-quality-control.html', icon: 'bi-clipboard-check' },
