...
class SpecialtyTreatmentController {
    ...
    renderOverview(data) {
        ...
        document.getElementById('treatmentAmount').textContent = safe(data && data.treatmentAmount).toLocaleString('zh-CN', { minimumFractionDigits: 1, maximumFractionDigits: 1 }) + '元';
